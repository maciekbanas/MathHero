...
player = Player(WIDTH // 2, HEIGHT // 2, "Rycerz")
enemies = [
...
def choose_character():
    ...
    """
    # Ustalamy docelową łączną szerokość dla 4 grafik: 90% szerokości ekranu
    total_width = int(0.9 * WIDTH)
    # Każda z 4 postaci dostaje równo 1/4 z 90% szerokości
...
while running:
    ...
    # Rysowanie paska życia gracza
    pygame.draw.rect(screen, RED, (player.x, player.y - 15, 50, 5))  # Pasek tła
    pygame.draw.rect(screen, GREEN,
                     (player.x, player.y - 15, 50 * (player.health / 100), 5))  # Pasek zdrowia proporcjonalny do HP
